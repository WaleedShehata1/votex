...
class HomeControllerImp extends HomeController {
  ...
  printRandomProductData() async {
    ...
    for (var bra in dataBrand) {
      for (var su in dataSubCategory) {
        items.add(
          ItemModel(
            ...
            imageUrl:
                "https://drive.google.com/file/d/18xOMr7qNZ8nNrhH2Re8HBL6DvWBed8_y/view?usp=sharing",
            itemDescription: faker.lorem.sentences(3).join(' '),
            itemName: faker.food.dish(),
            discount: (random.nextInt(99) + 1),
            imageIcon: su.imageSubCategores,
            idSubCategory: su.idSubCategores,
            price: (random.nextInt(50000) + 1000),
            rate: (random.nextInt(5) + 1).toString(),
            stock: (random.nextInt(100) + 1).toString(),
            supCategory: su.nameCategores,
            videoUrl:
                "https://firebasestorage.googleapis.com/v0/b/chat-app-d86a7.appspot.com/o/video%2FAc%20Home%20Appliances%203D%20Animation%20Video%20ad%20%2B91%209871556009.mp4?alt=media&token=1831c812-4bdd-4193-b242-5230ff7df079",
            dateAdd: DateTime.now().toIso8601String(),
            itemSell: random.nextInt(1000),
          ),
        );
      }
    }
